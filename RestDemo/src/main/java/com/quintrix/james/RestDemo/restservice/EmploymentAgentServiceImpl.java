...
public class EmploymentAgentServiceImpl implements EmploymentAgentService {
  ...
  public List<EmploymentAgent> getEmploymentAgentList() {
    ...
    ResponseEntity<List<EmploymentAgent>> employmentAgenstListResponseEntity =
        restTemplate.exchange(agentServiceGetUrl, HttpMethod.GET, requestBody,
            new ParameterizedTypeReference<List<EmploymentAgent>>() {});
